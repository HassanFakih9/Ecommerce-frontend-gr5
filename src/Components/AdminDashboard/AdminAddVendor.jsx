    ...
    const addVendor = async () => {
        ...
        try {
            const response = await fetch(
              "http://localhost:8000/vendors/addVendor",
              {
                method: "POST",
                headers: {
        ...
        <div className="admin-info">
            ...
            <div className="admin-info1">
                ...
                <div className="admin-user">
                    ...
                    <div className=" text">
                        <input type="text" id="username" placeholder="First Name" className="login-input" onChange={(e) => setName(e.target.value)} />
                    </div>
                </div>
                <div className="user1">
                    ...
                    <div className=" text">
                        <input type="text" id="username" placeholder="Last Name" className="login-input" onChange={(e) => setLastName(e.target.value)}/>
                    </div>
                </div>
                <div className="user1">
                    ...
                    <div className=" text">
                        <input type="text" id="username" placeholder="Phone" className="login-input" onChange={(e) => setPhone(e.target.value)}/>
                    </div>
                </div>
                <div className="user1">
                ...
                <div className="user1">
                    ...
                    <div className=" text">
                        <input type="text" id="username" placeholder="Company-name" className="login-input" onChange={(e) => setCompany(e.target.value)}/>
                    </div>
                </div>
            </div>
